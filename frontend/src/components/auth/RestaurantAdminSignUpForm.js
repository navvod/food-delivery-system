...
const RestaurantAdminSignUpForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = {
      ...formData,
      role: 'restaurant_admin', // Hardcode role as 'restaurant_admin'
    };
  ...
  return (
    <div className="bg-white p-3 rounded-lg shadow-md w-full max-w-md">
      <h2 className="text-2xl font-bold text-secondary mb-4 text-center">Restaurant Admin Sign Up</h2>
...
export default RestaurantAdminSignUpForm;